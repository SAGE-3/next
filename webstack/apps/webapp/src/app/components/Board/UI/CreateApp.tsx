...
/**
 * Create an application for a given file type
 * 
 * @export
 ...
 * @param {string} userId 
 */
export function setupAppForFile(file: FileEntry, xDrop: number, yDrop: number,
  roomId: string, boardId: string, userId: string): AppSchema | undefined {
  const w = 400;
