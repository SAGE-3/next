...
import { MdLock, MdStar, MdExitToApp, MdLink, MdStarOutline, MdSettings } from 'react-icons/md';
...
export function BoardCard(props: { board: Board; selected: boolean; onClick: (board: Board) => void; usersPresent: number }) {
