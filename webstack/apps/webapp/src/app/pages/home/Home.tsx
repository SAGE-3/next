  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box padding="2" borderRadius="20" background={sidebarBackgroundColor}>
          {servers.length > 0 ? (
        ...
        <Box backgroundColor={sidebarBackgroundColor} borderRadius="20" my="3" overflow="hidden" height="100%" pt="5" pb="5">
          <Box
            display="flex"
            flexDirection="column"
            justifyItems="start"
