    ...
    k(['Width', 'Height'], function (e) {
      ...
      (y[t] = function () {
        ...
        (y['outer' + e] = function (t) {
          return (
            this[0]['offset' + e] +
            (t ? F(this, 'margin' + ('Width' === e ? 'Left' : 'Top')) + F(this, 'margin' + ('Width' === e ? 'Right' : 'Bottom')) : 0)
          );
        });
    }),
    y.extend({
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (e.length && !e[0].classList.contains('active')) {
                    if (
                      ('function' == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, e[0]), this.options.accordion)
                    ) {
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.isOpen &&
                    (this.$dropdownEl.css({ width: '', height: '', left: '', top: '', 'transform-origin': '' }), this._placeDropdown());
                },
              },
            ],
            [
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.isDragged &&
                    (0.2 < this.percentOpen ? this.open() : this._animateOut(), (this.isDragged = !1), (this._verticallyScrolling = !1));
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  e === M.keys.ENTER && 0 <= this.activeIndex
                    ...
                    (t.preventDefault(),
                      ...
                      0 <= this.activeIndex &&
                      ((this.$active = h(this.container).children('li').eq(this.activeIndex)), this.$active.addClass('active')));
                },
              },
              {
    ...
    var e = {
      ...
      t = (function (t) {
        function B(t, e) {
          ...
          return (
            B._isDate(n) ? (i.options.setDefaultDate ? (i.setDate(n, !0), i.setInputValue()) : i.gotoDate(n)) : i.gotoDate(new Date()),
            (i.isOpen = !1),
            i
          );
        }
    ...
    var i = {},
      t = (function (t) {
        function n(t, e) {
          ...
          var i = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, t, e));
          return (
            ((i.el.M_Range = i).options = s.extend({}, n.defaults, e)), (i._mousedown = !1), i._setupThumb(), i._setupEventHandlers(), i
          );
        }
        return (
          _inherits(n, Component),
            ...
            [
                ...
                value: function () {
                  if (!this._mousedown) {
                    ...
                    s(this.thumb).hasClass('active') &&
                      (e.remove(this.thumb),
                        e({ targets: this.thumb, height: 0, width: 0, top: 10, easing: 'easeOutQuad', marginLeft: t, duration: 100 })),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.remove(this.thumb),
                    e({ targets: this.thumb, height: 30, width: 30, top: -30, marginLeft: t, duration: 300, easing: 'easeOutQuint' });
                },
              },
              {
