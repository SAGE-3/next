...
import { name as NotebookName } from './apps/Notebook';
...
export const Applications = {
  ...
  [NotebookName]: { AppComponent: React.memo(Notebook.AppComponent), ToolbarComponent: Notebook.ToolbarComponent, GroupedToolbarComponent: Notebook.GroupedToolbarComponent },
