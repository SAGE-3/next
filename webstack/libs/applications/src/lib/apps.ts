...
import { name as JsonCandyName } from './apps/JsonCandy';
...
import JsonCandy from './apps/JsonCandy/JsonCandy';
...
export const Applications = {
  ...
  [JsonCandyName]: { AppComponent: React.memo(JsonCandy.AppComponent), ToolbarComponent: JsonCandy.ToolbarComponent},
