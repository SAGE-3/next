...
import { name as AIDrawName } from './apps/AIDraw';
...
import AIDraw from './apps/AIDraw/AIDraw';
...
export const Applications = {
  [AIDrawName]: { AppComponent: React.memo(AIDraw.AppComponent), ToolbarComponent: AIDraw.ToolbarComponent },
