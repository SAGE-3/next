...
import { name as GuruName } from './apps/Guru';
...
import Guru from './apps/Guru/Guru';
...
export const Applications = {
  ...
  [GuruName]: { AppComponent: React.memo(Guru.AppComponent), ToolbarComponent: Guru.ToolbarComponent, GroupedToolbarComponent: Guru.GroupedToolbarComponent },
