...
export const Applications = {
  ...
  [ChartMakerName]: {
    AppComponent: React.memo(ChartMaker.AppComponent),
    ToolbarComponent: ChartMaker.ToolbarComponent,
    GroupedToolbarComponent: ChartMaker.GroupedToolbarComponent,
  },
  [ChatName]: {
  ...
  [CodeViewerName]: {
    AppComponent: React.memo(CodeViewer.AppComponent),
    ToolbarComponent: CodeViewer.ToolbarComponent,
    GroupedToolbarComponent: CodeViewer.GroupedToolbarComponent,
  },
  [CounterName]: {
  ...
  [NotesName]: {
    AppComponent: React.memo(Notes.AppComponent),
    ToolbarComponent: Notes.ToolbarComponent,
    GroupedToolbarComponent: Notes.GroupedToolbarComponent,
  },
  [PDFResultName]: {
