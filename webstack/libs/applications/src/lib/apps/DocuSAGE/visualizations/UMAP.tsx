...
export const UMAP = ({
  ...
  const ensureMinimumDistance = (points: UMAPPoint[], minDistance: number = 60, viewportSize: { width: number; height: number }): UMAPPoint[] => {
  ...
  const runUMAP = async () => {
    ...
    try {
      ...
      // Simple 2D projection using UMAP-like approach (different from t-SNE)
