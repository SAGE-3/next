...
function AppComponent(props: App): JSX.Element {
  ...
  // A lot of the code here can theortically be simplified under two assumptions
  // UID is generated by props._id
  // Backend does not do anything special on first init, like creating directories and such.
