...
const StationEditor: React.FC<StationEditorProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      <ModalOverlay />
      <ModalContent minHeight="60vh" minWidth="90vw" maxWidth="90vw" maxHeight="60vw" width="full" height="full" padding="2">
        <Box position="relative" height="full" width="full" borderRadius="5" overflow="hidden">
          ...
          ></Map>
          <Box position="absolute" top="0" left="0" padding="3" color="#222">
