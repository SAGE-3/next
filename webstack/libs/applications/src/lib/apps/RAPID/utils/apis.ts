...
export type MesonetQueryParams = {
  start?: string | Date;
  end?: string | Date;
  time?: string;
  metric?: string;
...
export type RAPIDQueries = {
  sageNode: SageNodeQueryParams;
  mesonet: MesonetQueryParams;
};
 ...
 */
export async function getSageNodeData(query: SageNodeQueryParams) {
  try {
 ...
 * @returns
 */
export async function getFormattedSageNodeData(query: SageNodeQueryParams) {
  try {
 ...
 * @returns
 */
export async function getFormattedMesonetData(query: MesonetQueryParams) {
  try {
 ...
 * @returns
 */
export async function getCombinedSageMesonetData(queries: RAPIDQueries) {
  try {
    ...
    const sageMap = new Map(sageData.map((obj: { time: string; value: number }) => [obj.time ? beautifyDate(obj.time) : null, obj.value]));
